package com.goormplay.adservice.ad.handler;

import com.goormplay.adservice.ad.dto.ErrorResultDto;
...
public class GlobalExControllerAdvice {
    ...
    @ExceptionHandler
    public Object adValidError(MethodArgumentNotValidException e){
